...
robotFactsList = ["Did you know that the first computer was the Z1 computer created by the German Konrad Zuse in the year 1936?",
                  ...
                  'The first use of the term "Robot" was in the play R.U.R.: Rossums Universal Robots. In this play, the robots overthrow their human creators.'
                  "In the late 1730s, Jacques de Vaucanson created a mechanical duck that had over 400 parts in the wings alone and could eat, digest, and excrete food.",
                  ]
pythonFactsList = ["Did you know that if you were to type in 'import this' in a python script, you would get a poem written by Tim Peters?",
                   "Did You know that the person who made Python, Guido Van Rossum, named the languange 'Python' not because of snakes, but because he really liked Monty Python's Flying Circus!",
...
indraFactsList = ["Did you know that this program was created with a programming language named Python? Python is actually a topic you can talk about in this program!",
                  "This simulation was inspired by a game called Doki Doki Literature Club. You should do some research about it!",
                  "When the creator of this simulation first started programming it, he only learned Python for 3 days!",
